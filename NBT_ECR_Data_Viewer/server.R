...
shinyServer(function(input, output, session) {
  ...
  Retail_Rates_Raw <- reactive({
    ...
    if(input$Utility_Name_Choose == "PG&E"){
      ...
      read.csv(paste0("https://raw.githubusercontent.com/RyanCMann/ACC_to_NBT_ECR/main/",
                      "Retail%20Rate%20Creation/SCE%20TOU-D-PRIME/2023/60-Minute%20Data/Dataframe%20Format/",
      ...
      read.csv(paste0("https://raw.githubusercontent.com/RyanCMann/ACC_to_NBT_ECR/main/",
                      "Retail%20Rate%20Creation/SDG%26E%20EV-TOU-5/2023/60-Minute%20Data/Dataframe%20Format/",
